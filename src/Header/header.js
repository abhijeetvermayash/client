  ...
  return (
    ...
    >
      ...
      <ul className="nav navbar-nav d-none d-sm-flex flex justify-content-start ml-8pt">
        ...
        <li className="nav-item dropdown">
          ...
          <div className="dropdown-menu">
            <Link to="boxed-courses.html" className="dropdown-item">
              Browse Courses
            </Link>
            ...
            <Link to="boxed-student-take-course.html" className="dropdown-item">
              <span className="mr-16pt">Take Course</span>{" "}
              <span className="badge badge-notifications badge-accent text-uppercase ml-auto">
                Pro
              </span>
            </Link>
            <Link to="boxed-student-take-lesson.html" className="dropdown-item">
              Take Lesson
            </Link>
            ...
            <Link to="boxed-student-my-courses.html" className="dropdown-item">
              My Courses
            </Link>
            <Link
        ...
        <li className="nav-item dropdown">
          ...
          <div className="dropdown-menu">
            ...
            <Link to="boxed-instructor-quizzes.html" className="dropdown-item">
              Manage Quizzes
            </Link>
            <Link to="boxed-instructor-earnings.html" className="dropdown-item">
              Earnings
            </Link>
            <Link
      ...
      <ul className="nav navbar-nav ml-auto mr-0">
        ...
        <li className="nav-item">
          <Link to="boxed-signup.html" className="btn btn-outline-white">
            Get Started
          </Link>
        </li>
      </ul>
